...
function Material.new(title)
	...
	function TabLibrary:Page(title)
		...
		function OptionLibrary:Keybind(kC)
			...
			textBg.Position = UDim2.new(1,-55,0,5)
			...
			text:GetPropertyChangedSignal('Text'):connect(function()
				...
				local newSize,newPos = UDim2.new(0,sizeOffset.X + 10,1,-10),UDim2.new(1,-(sizeOffset.X + 15),0,5)
				ts(textBg,{0.3,'Sine'},{
					Size = newSize,
					Position = newPos
				})
